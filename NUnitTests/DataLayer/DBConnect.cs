...
namespace BachelorProjectII.DataLayer
{
    public  class DBConnect
    {
        ...
        //public string DBConnectionsstring { get; private set; } = @"Server=devsql2.cim.as\sql2016;Database=IIDB;User ID=sa;Password=r5t6y7u8;MultipleActiveResultSets=True;TrustServerCertificate=True;";
