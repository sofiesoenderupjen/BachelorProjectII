...
namespace BachelorProjectII.DataLayer.Repositories
{
    public class PersonRepository : IPersonRepository
    {
        ...
        public async Task AddRandomReceptIndlaegssedlerForPerson(int personId)
        {
            using (SqlConnection connection = new SqlConnection(_dbConnect.DBConnectionsstring))
            {
                await connection.OpenAsync();
        ...
        public async Task<List<IndlaegsseddelModel>> GetGemteIndlaegssedler(int personId)
        {
        ...
        public async Task<List<IndlaegsseddelModel>> GetReceptIndlaegssedler(int personId)
        {
            var indlaegssedler = new List<IndlaegsseddelEntity>();
